...
def main(args):
    ...
    # submission = pd.read_csv(args.data_path + 'sample_submission_filtered.csv')
    if args.model in ['DCN']:
...
if __name__ == "__main__":
    ...
    arg('--epochs', type=int, default=100, help='Epoch 수를 조정할 수 있습니다.')
    ...
    arg('--early_stop', type=int, default=3, help='early stop 기준을 조정할 수 있습니다.')
    ...
    arg('--mlp_layers', type=int, default=3, help='에서 MLP Network의 레이어 수를 조정할 수 있습니다.')
